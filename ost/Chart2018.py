...
wd.find_element_by_xpath('//*[@id="d_chart_search"]/div/div/div[2]/div[1]/ul/li[2]/span/label').click()
    ...
    if(i==3 or i==5 or i==8 or i==11):
        ...
        for i in range(1,5):
            ...
            for rank, song_id in zip(ranks, song_ids):
                ...
                result.append(['2018'+str(cnt),rank.text,title,artist,album,genre])
                print(['2018'+str(cnt),rank.text,title,artist,album,genre])
...
data.to_csv("2018chart.csv",mode='w',encoding='utf-8-sig',index=False)
